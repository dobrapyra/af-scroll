...
})({"fLxwl":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "37d22a08e7696f4e";
"use strict";
...
},{}],"hyzuw":[function(require,module,exports) {
...
},{"../../../dist/module":"fZ2wh","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"fZ2wh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>$e9036bc7e4b4ba73$export$2e2bcd8739ae039
);
const $f42e5033b6ddf80e$export$79b2f7037acddd43 = (arr, cb)=>{
    const l = arr.length;
    for(let i = 0; i < l; i++){
...
const $f42e5033b6ddf80e$export$3a89f8d6f6bf6c9f = (begin, end, factor)=>{
    return begin + (end - begin) * factor;
};
const $f42e5033b6ddf80e$export$1d567c320f4763bc = (el, styles)=>{
    Object.keys(styles).forEach((styleKey)=>{
        el.style[styleKey] = styles[styleKey];
    });
};
var $f42e5033b6ddf80e$export$2e2bcd8739ae039 = {
    each: $f42e5033b6ddf80e$export$79b2f7037acddd43,
    lerp: $f42e5033b6ddf80e$export$3a89f8d6f6bf6c9f,
    style: $f42e5033b6ddf80e$export$1d567c320f4763bc
};
class $e9036bc7e4b4ba73$export$2e2bcd8739ae039 {
   ...
   */ createScroll() {
        ...
        $f42e5033b6ddf80e$export$1d567c320f4763bc(scrollEl, {
            position: 'fixed',
            top: 0,
            left: 0,
            width: '100%',
        ...
        const childrenArr = [];
        $f42e5033b6ddf80e$export$79b2f7037acddd43(bodyEl.children, (childEl)=>{
            if (childEl === scrollEl || childEl.matches(wrapExclude)) return true;
            childrenArr.push(childEl);
        });
        $f42e5033b6ddf80e$export$79b2f7037acddd43(childrenArr, (childEl)=>{
    ...
    smoothUpdate() {
        ...
        this.updateScroll($f42e5033b6ddf80e$export$3a89f8d6f6bf6c9f(this.lastScroll, this.targetScroll, this.smoothFactor));
        this.raf = requestAnimationFrame(this.smoothUpdateTick);
    }
    updateScroll(scroll) {
    ...
    singleResize() {
        $f42e5033b6ddf80e$export$1d567c320f4763bc(this.bodyEl, {
   ...
   */ removeScroll() {
        ...
        $f42e5033b6ddf80e$export$1d567c320f4763bc(bodyEl, {
            height: ''
        });
        const childrenArr = [];
        $f42e5033b6ddf80e$export$79b2f7037acddd43(scrollEl.children, (childEl)=>{
            childrenArr.push(childEl);
        });
        $f42e5033b6ddf80e$export$79b2f7037acddd43(childrenArr, (childEl)=>{
...
},{}]},["fLxwl","hyzuw"], "hyzuw", "parcelRequire5c71")

//# sourceMappingURL=index.e7696f4e.js.map
